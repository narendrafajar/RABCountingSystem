@section('pagetitle', __('Harga Satuan Pekerja'))
<x-app-layout>
    <div id="message-alert"></div>
    <div class="col-sm-12 col-md-12 col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">{{__('Daftar Harga Satuan Pekerja')}}</h4>
                <p class="card-description">
                    <code>{{__('Daftar untuk pengaturan harga satuan pekerja RAB')}}</code>
                </p>
                <div class="row">
